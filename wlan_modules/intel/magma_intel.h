...
enum magma_iwlwifi_read_len{
    MAGMA_IWLWIFI_DO_WRITE8 = 8,
    MAGMA_IWLWIFI_DO_WRITE32 = 32,
    MAGMA_IWLWIFI_DO_READ32 = 64,
...
void magma_iwlwifi_pcie_write8(void __iomem *hw_base, u32 offset, u8 value_to_write);
void magma_iwlwifi_pcie_write32(void __iomem *hw_base, u32 offset, u8 value_to_write);
u32 magma_iwlwifi_pcie_read32(void __iomem *hw_base, u32 offset);
...
/* magma_iwlwifi_main_io: write 8 bits or 32 bits at the specified offset in the WLAN card */
struct magma_iwlwifi_io_res *magma_iwlwifi_main_io(enum magma_iwlwifi_read_len magma_iwlwifi_readlength, u32 offset, u32 value_to_write){
    struct magma_iwlwifi_io_res *magma_io_struct = (struct magma_iwlwifi_io_res *)kmalloc(sizeof(magma_io_struct), GFP_KERNEL);
    struct pci_dev *magma_iwlwifi_pci_d;
